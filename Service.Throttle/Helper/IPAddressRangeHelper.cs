...
namespace Service.Throttle.Helper
{
    ...
    public class IPAddressRangeHelper
    {
        ...
        public IPAddressRangeHelper()
        {
            this.Begin = new IPAddress(0L);
            this.End = new IPAddress(0L);
        }

        public IPAddressRangeHelper(string ipRangeString)
        {
            // remove all spaces.
        ...
        protected IPAddressRangeHelper(SerializationInfo info, StreamingContext context)
        {
